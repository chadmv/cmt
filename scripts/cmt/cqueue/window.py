...
def restore_cursor():
    ...
    override_cursor = QtWidgets.qApp.overrideCursor()
    if override_cursor:
...
class CQueueWindow(MayaQWidgetDockableMixin, QtWidgets.QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.queue_widget.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
    ...
    def create_menu(self):
        ...
        action = QtWidgets.QAction('Load Queue', self)
        ...
        action = QtWidgets.QAction('Save Queue', self)
        ...
        self.recent_menu = QtWidgets.QMenu('Recent Queues', menu)
    ...
    def populate_recent_queue_menu(self):
        ...
        for queue in get_recent_queues():
            action = QtWidgets.QAction(queue, self)
...
class QueueWidget(QtWidgets.QWidget):
    ...
    def __init__(self, queue=None, parent=None):
        ...
        self.queue_layout = QtWidgets.QVBoxLayout(self)
    ...
    def mousePressEvent(self, event):
        ...
        QtWidgets.qApp.setOverrideCursor(QtGui.QCursor(QtCore.Qt.ClosedHandCursor))
    ...
    def on_component_execution_error(self, message, component):
        ...
        # Need to use spacer to set the message box width since setFixedWidth does not work.
    ...
    def get_component_widget(self, component):
        ...
        :return: The ComponentWidget of the Component.
        """
        for child in self.children():
...
class DropIndicator(QtWidgets.QWidget):
    """The widget used to display a Component in the ComponentQueue."""
