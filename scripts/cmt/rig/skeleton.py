...
ATTRIBUTES = ['translate', 'rotate', 'scale', 'radius', 'rotateOrder', 'rotateAxis', 'side',
              'type', 'otherType', 'jointTypeX', 'jointTypeY', 'jointTypeZ']
...
def dump(root=None, file_path=None):
    ...
    if file_path is None:
        file_path = cmds.fileDialog2(fileFilter='Skeleton Files (*{})'.format(EXTENSION),
                                     dialogStyle=2,
